...
\033[1;92m\n
 _______     ___    _______           _______ _________
(  ____ )   /   )  (  ____ )|\     /|(  ____ \\__    _/
| (    )|  / /) |  | (    )|| )   ( || (    \/   )  (  
| (____)| / (_) (_ | (____)|| |   | || (__       |  |  
|  _____)(____   _)|     __)( (   ) )|  __)      |  |  
...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: P4RVEJ
\033[1;92mFb \033[1;93m: Parvej Rana
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100039345052743')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtube.com/channel/UC8QlXVrA5cm7xfY6tHoY6Mg')
        main()
    else:
        print ''
